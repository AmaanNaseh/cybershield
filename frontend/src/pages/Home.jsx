  ...
  return (
    <>
      <div className="my-10 md:px-8 lg:px-20">
        <Slider {...settings}>
          <div className="bg-gradient-to-r from-white to-blue-700 text-white py-10 md:py-20">
      ...
      <div className="flex flex-wrap flex-col md:flex-row items-center justify-center gap-10 md:gap-20 text-white">
        <Link to={"/predict"}>
          <div className="flex flex-col items-center justify-center gap-4 bg-white shadow-md shadow-white rounded-lg text-black font-bold w-fit p-4 hover:scale-105">
